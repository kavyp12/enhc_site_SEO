...
export const blogData: { [key: number]: BlogData } = {
  1: {
    ...
    author: {
      ...
      initials: generateInitials("Dr. Sarah Chen"),
    },
    readTime: "8 min read",
  ...
  2: {
    ...
    author: {
      ...
      initials: generateInitials("Johnathan Chen"),
    },
...
3: {
  ...
  author: {
    name: "Peter Jones",
    role: "ML Engineer",
    initials: generateInitials("Peter Jones"),
  },
...
4: {
  ...
  author: {
    name: "Mike Williams",
    role: "AI Strategy Researcher",
    initials: generateInitials("Mike Williams"),
  },
...
5: {
  ...
  author: {
    ...
    initials: generateInitials("Emily White"),
  },
  readTime: "10 min read",
...
6 : {
  ...
  author: {
    ...
    initials: generateInitials("Chris Green"),
  },
  readTime: "9 min read",
